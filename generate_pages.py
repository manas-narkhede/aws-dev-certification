...
{day_groups}
  <div class="daygroup">
    ...
    <div class="mockrow">
      ...
      <div class="mockcard">
        <h3>Mock Exam 3 &middot; exam-level</h3>
        <p>Harder than mocks 1&ndash;2: longer scenarios, full-sentence options, 13 Select TWO, answers spread evenly. Aim for 47+/65.</p>
        <div class="mactions"><a class="btn btn-primary btn-sm" href="18-Mock-Exams/mock-exam-3.html">Start exam &rarr;</a></div>
      </div>
    </div>
  </div>
</main>
