#!/usr/bin/env python3
"""Generate 125 practice questions for Module 13: Infrastructure as Code (CloudFormation, SAM, CDK)"""

import os

questions_text = """# Module 13 — Practice Questions (125)
...
with open("13-IaC-CloudFormation-SAM-CDK/questions.md", "w", encoding="utf-8") as f:
    f.write(questions_text)

print("Successfully wrote 13-IaC-CloudFormation-SAM-CDK/questions.md")
