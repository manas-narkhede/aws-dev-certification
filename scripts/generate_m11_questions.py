#!/usr/bin/env python3
"""Generate 125 practice questions for Module 11: Elastic Beanstalk, Amplify & Copilot"""

import os

questions_text = """# Module 11 — Practice Questions (125)
...
with open("11-Elastic-Beanstalk-Amplify-Copilot/questions.md", "w", encoding="utf-8") as f:
    f.write(questions_text)

print("Successfully wrote 11-Elastic-Beanstalk-Amplify-Copilot/questions.md")
