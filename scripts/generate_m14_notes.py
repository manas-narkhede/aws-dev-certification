#!/usr/bin/env python3
"""Generate thorough, comprehensive notes.md for Module 14: Security Deep Dive (Domain 2: 26%)"""

import os

notes_text = """# Module 14 — Security Deep Dive
...
with open("14-Security-Deep-Dive/notes.md", "w", encoding="utf-8") as f:
    f.write(notes_text)

print(f"Successfully wrote 14-Security-Deep-Dive/notes.md ({len(notes_text.split())} words)")
