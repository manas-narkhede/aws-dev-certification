#!/usr/bin/env python3
"""Generate 115 practice questions for Module 17: Well-Architected and Exam Strategy"""

import os

questions_text = """# Module 17 — Practice Questions (115)
...
with open("17-Well-Architected-and-Exam-Strategy/questions.md", "w", encoding="utf-8") as f:
    f.write(questions_text)

print(f"Successfully wrote 17-Well-Architected-and-Exam-Strategy/questions.md ({len(questions_text.split())} words)")
