#!/usr/bin/env python3
"""Generate 135 practice questions for Module 14: Security Deep Dive (Domain 2: 26%)"""

import os

questions_text = """# Module 14 — Practice Questions (135)
...
with open("14-Security-Deep-Dive/questions.md", "w", encoding="utf-8") as f:
    f.write(questions_text)

print(f"Successfully wrote 14-Security-Deep-Dive/questions.md ({len(questions_text.split())} words)")
