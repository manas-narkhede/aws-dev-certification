#!/usr/bin/env python3
"""Generate comprehensive notes.md for Module 17: Well-Architected and Exam Strategy"""

import os

notes_text = """# Module 17 — Well-Architected Framework & Exam Strategy
...
with open("17-Well-Architected-and-Exam-Strategy/notes.md", "w", encoding="utf-8") as f:
    f.write(notes_text)

print(f"Successfully wrote 17-Well-Architected-and-Exam-Strategy/notes.md ({len(notes_text.split())} words)")
