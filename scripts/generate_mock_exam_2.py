#!/usr/bin/env python3
"""Generate mock-exam-2.md for Module 18: Mock Exams"""

import os

mock2_text = """# DVA-C02 Full Practice Mock Exam 2 (65 Questions)
...
with open("18-Mock-Exams/mock-exam-2.md", "w", encoding="utf-8") as f:
    f.write(mock2_text)

print(f"Successfully wrote 18-Mock-Exams/mock-exam-2.md ({len(mock2_text.split())} words)")
